...
def get_project_by_title(title):
    ...
    print "Here is the description for your title : %s" %result
...
def get_grade_by_github_title(github, title):
    ...
    print "Grade received by student is %s" %result
...
def assign_grade(github, title, grade):
    ...
    print "Successfully added %s working on %s with following grade: %s" % (github, title, grade)
...
def handle_input():
    ...
    while command != "quit":
        ...
        elif command == "grade_recieved":
            github, title = args  # unpack!
            get_grade_by_github_title (github, title)

        elif command == "updated_grade":
